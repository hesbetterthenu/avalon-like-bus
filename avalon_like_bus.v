...
//bus:end------------------------------------------------------------------------------------------
//inbus:definition---------------------------------------------------------------------------------
.read_i(read_i[DEVICE_ID]),
.write_i(write_i[DEVICE_ID]),
.chipselect_i(chipselect_i[DEVICE_ID]),
.data_i(data_i[DEVICE_ID]),
.address_i(address_i[DEVICE_ID]),
.flush_i(flush_i[DEVICE_ID]),
.irq_o(irq_o[DEVICE_ID]),
.readyfordata_o(readyfordata_o[DEVICE_ID]),
.dataavailable_o(dataavailable_o[DEVICE_ID]),
.endofpocket_o(endofpocket_o[DEVICE_ID]),
.slaveid_o(slaveid_o[DEVICE_ID]),
.data_o(data_o[DEVICE_ID]),
.address_o(address_o[DEVICE_ID]),
.hold_t(hold_t[DEVICE_ID]),
.wait_t(wait_t[DEVICE_ID]),
//-------------------------------------------------------------------------------------------------
